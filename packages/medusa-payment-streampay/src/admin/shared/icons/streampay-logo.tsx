...
const StreamPayLogo: React.FC<React.SVGAttributes<SVGElement>> = ({}) => {
  return (
    <svg
      width="40"
      height="40"
    ...
    >
      ...
      <rect x="4" y="4" width="32" height="32" rx="4" fill="#090D15" />
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
        ...
        fill="white"
      />
      <rect x="0.5" y="0.5" width="39" height="39" rx="7.5" stroke="#090D15" />
    </svg>
  )
}
